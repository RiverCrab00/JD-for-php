...
<body>
    ...
    <div class="rightinfo">
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($manager_list)): $i = 0; $__LIST__ = $manager_list;if( count($__LIST__)==0 ) : echo "没有数据" ;else: foreach($__LIST__ as $key=>$ov): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <?php if($ov["role_name"] == '超级管理员'): ?><td><font color="red"><?php echo ($ov["role_name"]); ?></font></td>
                    <?php else: ?>   
                    <td><?php echo ($ov["role_name"]); ?></td><?php endif; ?>
                    <td><a href="#" class="tablelink">查看</a> <a href="<?php echo U('delManager','id='.$ov[manager_id]);?>" class="tablelink"> 删除</a></td>
    ...
    <script type="text/javascript">
        ...
        $('li:contains("添加")').click(function(){
           location.href="<?php echo U('addManager');?>";
        })
    </script>
</body>
