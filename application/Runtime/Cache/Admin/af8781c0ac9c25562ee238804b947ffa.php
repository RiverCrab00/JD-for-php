...
<body>
    ...
    <div class="rightinfo">
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($goods_list)): foreach($goods_list as $key=>$ov): ?><tr>
                    <td>
                        <input name="" type="checkbox" value="<?php echo ($ov["goods_id"]); ?>" />
                    </td>
    ...
    <script type="text/javascript">
        ...
        $('#checkAll').click(
            function(){
                $.each($(':checkbox:not("#checkAll")'),function(){
                    $(this).attr('checked',!$(this).attr('checked'));
                })
            }
        )
        $('li:contains("删除")').click(
            function(){
                $.each($(':checkbox:not("#checkAll").attr('checked',true)'),function(){
                    alert(1);
                }                
            }
        )
