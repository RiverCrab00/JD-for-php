	...
	<div class="main w1210 mt10 bc">
					...
					<form action="" method="post" class="choose">
						...
						<?php if(is_array($attr_select)): foreach($attr_select as $key=>$vo): ?><li class="product">
								<dl>
									...
									<dd>
									<?php if(is_array($vo["ga_attrvals"])): foreach($vo["ga_attrvals"] as $key=>$v): if($key == 0 ): ?><a class="selected" href="javascript:;"><?php echo ($v); ?><input type="radio" name="<?php echo ($vo["attr_name"]); ?>" value="<?php echo ($v); ?>" checked="checked" /></a>
									<?php else: ?>
										<a href="javascript:;"><?php echo ($v); ?><input type="radio" name="<?php echo ($vo["attr_name"]); ?>" value="<?php echo ($v); ?>" /></a><?php endif; ?>
		...
		<li>
			<dl>
				<dt>&nbsp;</dt>
				<dd>
					<input type="button" data="<?php echo ($goods_info["goods_id"]); ?>" class="add_btn"  id='add_btn' />
				</dd>
			</dl>
		</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($attr_list)): foreach($attr_list as $key=>$vo): ?><li><span><?php echo ($vo["attr_name"]); ?>：</span><?php echo ($vo["ga_attrvals"]); ?></li><?php endforeach; endif; ?>
							</ul>
						</div>
